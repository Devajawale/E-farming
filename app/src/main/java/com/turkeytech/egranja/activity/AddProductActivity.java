...
public class AddProductActivity extends AppCompatActivity implements
    ...
    private static final String TAG = "xix: AddProductActivity";
    ...
    @BindView(R.id.addProduct_rootLayout)
    CoordinatorLayout mRootLayout;

    @BindView(R.id.addProduct_progressBar)
    ProgressBar mProgressBar;

    @BindView(R.id.addProduct_txtProductName)
    TextInputEditText mTextProductName;

    @BindView(R.id.addProduct_txtProductDescription)
    TextInputEditText mTextProductDescription;

    @BindView(R.id.addProduct_txtProductQuantity)
    TextInputEditText mTextProductQuantity;

    @BindView(R.id.addProduct_quantityUnit)
    Spinner mSpinQuantityUnit;

    @BindView(R.id.addProduct_txtPrice)
    TextInputEditText mTextProductPrice;

    @BindView(R.id.addProduct_categories)
    Spinner mSpinCategory;

    @BindView(R.id.addProduct_btnAddImage1)
    ImageButton mImageButton1;

    @BindView(R.id.addProduct_btnAddImage2)
    ImageButton mImageButton2;

    @BindView(R.id.addProduct_btnAddImage3)
    ImageButton mImageButton3;

    @BindView(R.id.addProduct_btnAddImage4)
    ImageButton mImageButton4;

    @BindView(R.id.addProduct_btnRecordAudio)
    Button mButtonRecordAudio;

    @BindView(R.id.addProduct_btnUploadVideo)
    Button mButtonUploadVideo;

    @BindView(R.id.addProduct_btnCurrentLocation)
    ...
    @OnClick({
            R.id.addProduct_btnAddImage1,
            R.id.addProduct_btnAddImage2,
            R.id.addProduct_btnAddImage3,
            R.id.addProduct_btnAddImage4
    })
    public void imageButtonClicked(ImageButton button) {
    ...
    @OnClick(R.id.addProduct_btnRecordAudio)
    ...
    @OnClick(R.id.addProduct_btnUploadVideo)
    ...
    // Location Section
    @OnClick(R.id.addProduct_btnCurrentLocation)
    ...
    @OnClick(R.id.addProduct_btnToolbarClose)
    @Override
    ...
    class AddressResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            if (resultCode == Constants.SUCCESS_RESULT) {
                ...
                Toast.makeText(AddProductActivity.this, addressOutput, Toast.LENGTH_SHORT).show();
            }
